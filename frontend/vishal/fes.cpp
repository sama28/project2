...
extern int 	Project( int,char ** ),		 Select( int,char ** ),
		...
		Load( int,char ** ),		 Print( int,char ** ),
		BuildIndex( int,char ** ), 	 DropIndex( int,char ** ),
		Quit( int, char ** ), 		 Join( int, char ** ),
		Insert( int, char ** ), 	 Delete( int, char ** );
...
int
processquery (char	*buff,char	**ptr)
{
